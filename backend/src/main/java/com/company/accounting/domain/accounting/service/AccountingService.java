package com.company.accounting.domain.accounting.service;
...
import com.company.accounting.domain.accounting.dto.JournalEntryLineDto;
...
import com.company.accounting.domain.accounting.entity.JournalEntryLine;
import com.company.accounting.domain.accounting.entity.Ledger;
import com.company.accounting.domain.accounting.repository.JournalEntryRepository;
...
public class AccountingService {
    ...
    public JournalEntryDto postJournalEntry(JournalEntryCreateRequest request) {
        ...
        for (JournalEntryLineRequest lineReq : request.getLines()) {
            Ledger ledger = ledgerRepository.findById(lineReq.getLedgerId())
